package org.generation.blogPessoalTeste.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.generation.blogPessoalTeste.controller"))
	...
	private static Contact contact() {
		return new Contact("Esdras Teixeira", "https://github.com/esdrashx", "esdrashx@gmail.com");
	}
